            ...
            <div className="layout-container flex h-full grow flex-col">
                <div className="gap-1 px-6 flex flex-1 py-5">
                    ...
                    <div className="layout-content-container flex flex-col">
                        <div className="flex flex-wrap justify-between gap-3 p-4"><p className="text-[#111517] tracking-light text-[32px] font-bold leading-tight min-w-72 dark:text-white">Campaigns</p></div>
                    </div>
                </div>
            </div>
        </div>
